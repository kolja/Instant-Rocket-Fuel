...
(function() {
  ...
  Game = (function() {
    Game.addScene = function(sceneName, scene) {
      var _ref1;

      if ((_ref1 = this.sceneManager) == null) {
        this.sceneManager = new SceneManager();
      }
      return this.sceneManager.addScene(sceneName, scene);
    };
  ...
  SceneManager = (function() {
    ...
    SceneManager.prototype.addScene = function(sceneName, sceneClass) {
      return this.scenes[sceneName] = sceneClass;
    };

    SceneManager.prototype.setScene = function(scene, parent) {
      return this.currentScene = new this.scenes[scene](parent);
    };
