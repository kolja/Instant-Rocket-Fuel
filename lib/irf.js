...
(function() {
  var Animation, Background, BoundingBox, Camera, EventManager, Game, Keyboard, Map, Scene, SceneManager, Shape, Sprite, Tile, Timer, Vector, root, sceneclass, _ref,
  ...
  this.irf.Background = Background = (function() {
  ...
  this.irf.BoundingBox = BoundingBox = (function() {
  ...
  this.irf.Camera = Camera = (function() {
  ...
  this.irf.EventManager = EventManager = (function() {
  ...
  this.irf.Keyboard = Keyboard = (function() {
    function Keyboard() {
      var code, name, _ref1,
        _this = this;
  ...
  this.irf.SceneManager = SceneManager = (function() {
  ...
  this.irf.Sprite = Sprite = (function() {
  ...
  this.irf.Animation = Animation = (function() {
  ...
  this.irf.Vector = Vector = (function() {
    function Vector(x, y) {
      if (x == null) {
        x = 0;
      }
