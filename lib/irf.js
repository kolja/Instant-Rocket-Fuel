...
(function() {
  var Animation, Background, BoundingBox, Camera, EventManager, Game, Helpers, Keyboard, Map, Scene, SceneManager, Shape, Sprite, Tile, Timer, Vector, _ref,
  ...
  Game = (function() {
    Game.addScene = function(scene) {
      ...
      if ((_ref1 = this.sceneManager) == null) {
  ...
  SceneManager = (function() {
    ...
    SceneManager.prototype.setScene = function(scene, parent) {
      ...
      return this.currentScene = (_ref1 = (_base = this.scenes[scene]).instance) != null ? _ref1 : _base.instance = new this.scenes[scene]["class"](parent);
    };
